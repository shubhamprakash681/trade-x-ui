      ...
      <div className="mx-auto max-w-5xl space-y-6">
        <div>
          <h1 className="flex items-center gap-2 text-3xl font-bold text-text-primary">
            <Heart className="h-7 w-7 text-loss" />Watchlist
          </h1>
          <p className="mt-1 text-text-secondary">Instruments you have saved for quick access.</p>
        </div>
        <Card className="p-0">
          <CardHeader className="mb-0 border-b border-border-primary px-5 py-4">
            <CardTitle>Saved instruments</CardTitle>
          </CardHeader>
          <CardContent>
