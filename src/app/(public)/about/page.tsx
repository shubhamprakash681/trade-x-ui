    ...
    <div className="py-8 sm:py-12">
      <div className="mx-auto max-w-4xl px-4 sm:px-6">
        ...
        <div className="space-y-12">
          {/* Header */}
          <div className="space-y-3 border-b border-border-primary pb-8">
            ...
            <h1 className="text-3xl font-extrabold tracking-tight text-text-primary sm:text-4xl">About TradeX</h1>
          ...
          <section className="space-y-4">
            ...
            <div className="rounded-2xl border border-border-primary bg-bg-secondary p-6 sm:p-8">
              <blockquote className="text-lg sm:text-xl font-medium italic text-text-primary leading-relaxed">
          ...
          <section className="space-y-6">
            <h2 className="text-2xl font-bold text-text-primary">Key Platform Features</h2>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="flex gap-4 rounded-xl border border-border-primary bg-bg-secondary p-5">
                <div className="mt-1 flex h-10 w-10 shrink-0 items-center justify-center rounded-lg bg-brand/10 text-brand">
                  <TrendingUp className="h-5 w-5" />
                </div>
                <div>
                  <h3 className="text-base font-semibold text-text-primary mb-1">Real-Time Simulated Market Data</h3>
              ...
              <div className="flex gap-4 rounded-xl border border-border-primary bg-bg-secondary p-5">
                <div className="mt-1 flex h-10 w-10 shrink-0 items-center justify-center rounded-lg bg-profit/10 text-profit">
                  <Wallet className="h-5 w-5" />
                </div>
                <div>
                  <h3 className="text-base font-semibold text-text-primary mb-1">Virtual Portfolio & P&L Engine</h3>
                  <p className="text-sm text-text-secondary">
              ...
              <div className="flex gap-4 rounded-xl border border-border-primary bg-bg-secondary p-5">
                <div className="mt-1 flex h-10 w-10 shrink-0 items-center justify-center rounded-lg bg-brand-secondary/10 text-brand-secondary">
                  <BarChart3 className="h-5 w-5" />
                </div>
                <div>
                  <h3 className="text-base font-semibold text-text-primary mb-1">TradingView Lightweight Charts</h3>
                  <p className="text-sm text-text-secondary">
              ...
              <div className="flex gap-4 rounded-xl border border-border-primary bg-bg-secondary p-5">
                <div className="mt-1 flex h-10 w-10 shrink-0 items-center justify-center rounded-lg bg-warning/10 text-warning">
                  <Zap className="h-5 w-5" />
                </div>
                <div>
                  <h3 className="text-base font-semibold text-text-primary mb-1">Fast Simulated Order Matching</h3>
                  <p className="text-sm text-text-secondary">
              ...
              <div className="flex gap-4 rounded-xl border border-border-primary bg-bg-secondary p-5">
                <div className="mt-1 flex h-10 w-10 shrink-0 items-center justify-center rounded-lg bg-brand-accent/10 text-brand-accent">
                  <Bell className="h-5 w-5" />
                </div>
                <div>
                  <h3 className="text-base font-semibold text-text-primary mb-1">Target Price Alert System</h3>
                  <p className="text-sm text-text-secondary">
              ...
              <div className="flex gap-4 rounded-xl border border-border-primary bg-bg-secondary p-5">
                ...
                <div>
                  <h3 className="text-base font-semibold text-text-primary mb-1">100% Risk-Free & Free Forever</h3>
                  <p className="text-sm text-text-secondary">
          ...
          <section className="space-y-4">
            <h2 className="text-2xl font-bold text-text-primary">Architecture & Engineering Stack</h2>
          ...
          <section className="space-y-4 border-t border-border-primary pt-8">
            <h2 className="text-2xl font-bold text-text-primary">About the Developer</h2>
            <div className="rounded-2xl border border-border-primary bg-bg-secondary p-6 sm:p-8 space-y-4">
              <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                <div>
                  <h3 className="text-xl font-bold text-text-primary">Shubham Prakash</h3>
                  <p className="text-sm text-text-secondary">
          ...
          <section className="space-y-4 rounded-2xl border border-border-primary bg-bg-secondary p-8 text-center sm:text-left">
            <h2 className="text-2xl font-bold text-text-primary">Explore TradeX Today</h2>
            ...
            <div className="flex flex-col sm:flex-row items-center gap-3 pt-2">
              <Link href="/register">
                <Button variant="primary">Start Paper Trading</Button>
              </Link>
              <Link href="/markets">
                <Button variant="secondary">View Live Markets</Button>
              </Link>
              <a
                href="mailto:shubhamprakash681@gmail.com"
                className="text-xs text-text-tertiary hover:text-brand hover:underline sm:ml-4"
              >
