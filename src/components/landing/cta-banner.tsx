  ...
  return (
    <section className="py-16 bg-bg-secondary/60 border-t border-border-primary">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="relative overflow-hidden rounded-3xl border border-brand/30 bg-gradient-to-br from-brand/20 via-brand-accent/15 to-brand-secondary/20 p-8 sm:p-14 text-center shadow-xl">
          {/* Subtle glowing orb */}
          ...
          <div className="inline-flex items-center gap-1.5 rounded-full border border-brand/30 bg-bg-primary/80 px-3.5 py-1 text-xs font-semibold text-brand mb-6 backdrop-blur-sm">
            <Sparkles className="h-3.5 w-3.5" />
            <span>Instant Virtual Capital Access</span>
          </div>

          <h2 className="text-3xl sm:text-5xl font-extrabold text-text-primary tracking-tight max-w-2xl mx-auto leading-tight">
